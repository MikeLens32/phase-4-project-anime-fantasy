...
goku = Character.create(name: 'Goku', img: '../assets/Character-05.png', alt: 'Goku', health: 4000, attack: 2000, defense: 1000, stamina: 1,  ult_move: 3500)
LeagueCharacter.create(character: goku, league: mwa)
LeagueCharacter.create(character: goku, league: hnc)
saitama = Character.create(name: 'Saitama', img: '../assets/Characers-16.png', alt: 'Saitama', health: 4000, attack: 1500, defense: 1000, stamina: 1,  ult_move: 3000)
LeagueCharacter.create(character: saitama, league: mwa)
LeagueCharacter.create(character: saitama, league: hnc)
deku = Character.create(name: 'Deku', img: '../assets/Characers-02.png', alt:'Deku', health: 1500, attack: 700, defense: 800, stamina: 4,  ult_move: 1500)
LeagueCharacter.create(character: deku, league: mwa)
LeagueCharacter.create(character: deku, league: hnc)
gojo = Character.create(name: 'Gojo', img: '../assets/Characers-04.png', alt: 'Gojo', health: 2500, attack: 1500, defense: 2500, stamina: 1,  ult_move: 2200)
LeagueCharacter.create(character: gojo, league: mwa)
LeagueCharacter.create(character: gojo, league: hnc)
rimuru = Character.create(name: 'Rimuru', img:'../assets/Characers-15.png', alt: 'Rimuru', health: 3000, attack: 1000, defense: 2000, stamina: 1,  ult_move: 2200)
LeagueCharacter.create(character: rimuru, league: mwa)
LeagueCharacter.create(character: rimuru, league: hnc)
luffy = Character.create(name: 'Luffy', img: '../assets/Characers-11.png', alt: 'Luffy', health: 4000, attack: 1300, defense: 2300, stamina: 2,  ult_move: 2000)
LeagueCharacter.create(character: luffy, league: mwa)
LeagueCharacter.create(character: luffy, league: hnc)
law = Character.create(name: 'Law', img: '../assets/Characers-10.png', alt: 'Law', health: 2000, attack: 1200, defense: 1500, stamina: 3,  ult_move: 1700)
LeagueCharacter.create(character: law, league: mwa)
LeagueCharacter.create(character: law, league: hnc)
kid = Character.create(name: 'Kid', img: '../assets/Characers-08.png', alt: 'Kid', health: 2000, attack: 900, defense: 1800, stamina: 3,  ult_move: 1500)
LeagueCharacter.create(character: kid, league: mwa)
LeagueCharacter.create(character: kid, league: hnc)
megumi = Character.create(name: 'Vergil', img: '../assets/Characers-20.png', alt: 'Vergil', health: 1200, attack: 800, defense: 1000, stamina: 2,  ult_move: 1800)
LeagueCharacter.create(character: megumi, league: mwa)
LeagueCharacter.create(character: megumi, league: hnc)
sakuna = Character.create(name: 'Sakuna', img: '../assets/Characers-19.png', alt: 'Sakuna', health: 3000, attack: 2000, defense: 1200, stamina: 1,  ult_move: 2500)
LeagueCharacter.create(character: sakuna, league: mwa)
LeagueCharacter.create(character: sakuna, league: hnc)
vegeta = Character.create(name: 'Vegeta', img: '../assets/Characers-17.png', alt: 'Vegeta', health: 4000, attack: 1800, defense: 1000, stamina: 1,  ult_move: 3000)
LeagueCharacter.create(character: vegeta, league: mwa)
LeagueCharacter.create(character: vegeta, league: hnc)
yusake = Character.create(name: 'Yusake', img: '../assets/Characers-18.png', alt: 'Yusake', health: 3000, attack: 1400, defense: 1200, stamina: 2,  ult_move: 1800)
LeagueCharacter.create(character: yusake, league: mwa)
LeagueCharacter.create(character: yusake, league: hnc)
naruto = Character.create(name: 'Naruto', img: '../assets/Characers-13.png', alt: 'Naruto', health: 3200, attack: 1300, defense: 1200, stamina: 1,  ult_move: 2500)
LeagueCharacter.create(character: naruto, league: mwa)
LeagueCharacter.create(character: naruto, league: hnc)
sasuke = Character.create(name: 'Sasuke', img: '../assets/Characers-14.png', alt: 'Sasuke', health: 3000, attack: 1200, defense: 1400, stamina: 1,  ult_move: 2300)
LeagueCharacter.create(character: sasuke, league: mwa)
LeagueCharacter.create(character: sasuke, league: hnc)
kanekie = Character.create(name: 'Kanekie', img: '../assets/Characers-07.png', alt: 'Kanekie', health: 2500, attack: 1000, defense: 1500, stamina: 3,  ult_move: 1400)
LeagueCharacter.create(character: kanekie, league: mwa)
LeagueCharacter.create(character: kanekie, league: hnc)
ichigo = Character.create(name: 'Ichigo', img: '../assets/Characers-06.png', alt: 'Ichigo', health: 2000, attack: 1500, defense: 1000, stamina: 1,  ult_move: 2500)
LeagueCharacter.create(character: ichigo, league: mwa)
LeagueCharacter.create(character: ichigo, league: hnc)
asta = Character.create(name: 'Asta', img:'../assets/Characers-01.png', alt: 'Asta',  health: 1500, attack: 1200, defense: 1800, stamina: 2,  ult_move: 1800)
LeagueCharacter.create(character: asta, league: mwa)
LeagueCharacter.create(character: asta, league: hnc)
yuno = Character.create(name: 'Gohan', img: '../assets/Characers-03.png', alt: 'Gohan', health: 1800, attack: 1500, defense: 1500, stamina: 2,  ult_move: 2000)
LeagueCharacter.create(character: yuno, league: mwa)
LeagueCharacter.create(character: yuno, league: hnc)
mob = Character.create(name: 'Mob', img: '../assets/Characers-12.png', alt: 'Mob', health: 2500, attack: 1500, defense: 1200, stamina: 1,  ult_move: 3500)
LeagueCharacter.create(character: mob, league: mwa)
LeagueCharacter.create(character: mob, league: hnc)
koro_sensie = Character.create(name: 'Koro Sensie', img: '../assets/Characers-09.png', alt: 'Koro Sensie', health: 2500, attack: 1800, defense: 2000, stamina: 1,  ult_move: 2000)
