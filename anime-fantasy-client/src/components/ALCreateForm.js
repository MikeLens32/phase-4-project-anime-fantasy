  ...
  return (
    <div>
        ...
        <h2>Create League</h2>
            ...
            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name='name' onChange={handleChange} value={league.name} type='text' placeholder='League Name'/>
            <br/>
